      ...
      <div className="min-h-screen bg-gray-100 py-10">
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex justify-between items-center mb-6">
            <h1 className="text-3xl font-bold text-gray-800">Make Your NRC and NFT</h1>
            {!walletAddress ? (
              <button
                onClick={connectWallet}
                className="bg-black text-white px-3 py-2 rounded hover:bg-gray-900 transition duration-200"
              >
                Connect Wallet
              </button>
            ) : (
              <p className="text-sm text-gray-600 truncate max-w-xs">Connected: {walletAddress}</p>
            )}
          </div>
